<template>
	<div class="diy_home diy_list diy_delivery_record" id="diy_delivery_record_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/delivery_record/details?delivery_record_id=' + o['delivery_record_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/delivery_record/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/delivery_record/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','delivery_fee')">投递费用
					</th>
					<th class="diy_title" v-if="$check_field('get','total_cost')">合计费用
					</th>
					<th class="diy_title" v-if="$check_field('get','receiving_address')">收取地址
					</th>
					<th class="diy_title" v-if="$check_field('get','delivery_clerk')">投递员
					</th>
					<th class="diy_title" v-if="$check_field('get','dispatch_status')">派送状态
					</th>
					<th class="diy_title" v-if="$check_field('get','delivery_time')">投递时间
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','delivery_fee')">
						<span>
							{{ o["delivery_fee"] }}
						</span>
					</td>
					...
					<td class="diy_field diy_uid" v-if="$check_field('get','delivery_clerk')">
						<span>
							{{ get_user_name(o['delivery_clerk']) }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','dispatch_status')">
						<span>
							{{ o["dispatch_status"] }}
						</span>
					</td>
					<td class="diy_field diy_date" v-if="$check_field('get','delivery_time')">
						<span>
							{{ $toTime(o["delivery_time"] ,"yyyy-MM-dd") }}
						</span>
					</td>
				</tr>
			</table>
