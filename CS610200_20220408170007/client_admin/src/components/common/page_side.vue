<template>
	...
	<el-submenu index="user"
		...
		<el-menu-item index="/delivery_clerk/table" v-show="user_group == '管理员' || $check_action('/delivery_clerk/table')"><span>投递员</span></el-menu-item>
