<template>
	<div class="diy_details page_laundry_service" id="laundry_service_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_laundry_service'>
							<div_laundry_service :obj="obj"></div_laundry_service>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_laundry_service from "@/components/diy/div_laundry_service.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/laundry_service/set?laundry_service_id=' + obj["laundry_service_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "laundry_service",
					source_field: "laundry_service_id",
					source_id: obj["laundry_service_id"],
					user_id
				};
